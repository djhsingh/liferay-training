package com.train.liferay.simulation.panel.entry.application.list;
...
public class CustomSimulationPanelEntrySimulationPanelApp extends BaseJSPPanelApp {
	...
	@Reference(
		target = "(osgi.web.symbolicname=simulation-panel-entry)"
	)
